...
const routes = [
  ...
  { path: '/services/accountant-in-brighton',                                   changefreq: 'monthly', priority: '0.8' },
  { path: '/services/accountant-in-cheltenham',                                 changefreq: 'monthly', priority: '0.8' },
  { path: '/services/accountant-in-moorabbin',                                  changefreq: 'monthly', priority: '0.8' },
  { path: '/services/accountant-in-bentleigh',                                  changefreq: 'monthly', priority: '0.8' },
  { path: '/services/accountant-in-mordialloc',                                 changefreq: 'monthly', priority: '0.8' },
  { path: '/services/accountant-in-parkdale',                                   changefreq: 'monthly', priority: '0.8' },
  { path: '/services/accountant-in-braeside',                                   changefreq: 'monthly', priority: '0.8' },
  { path: '/services/accountant-in-sandringham',                                changefreq: 'monthly', priority: '0.8' },
  { path: '/services/accountant-in-mentone',                                    changefreq: 'monthly', priority: '0.8' },

  // ─── Blog ───────────────────────────────────────────────────────────────
  { path: '/blog',                                                     changefreq: 'weekly',  priority: '0.8' },
  { path: '/what-is-a-chart-of-accounts',                              changefreq: 'yearly',  priority: '0.7', lastmod: '2026-09-02' },
  { path: '/difference-between-bookkeeping-and-accounting',            changefreq: 'yearly',  priority: '0.7', lastmod: '2026-09-03' },
  { path: '/logbook-method-ato',                                       changefreq: 'yearly',  priority: '0.7', lastmod: '2026-09-04' },
  ...
  { path: '/agent-nomination-ato',                                changefreq: 'yearly',  priority: '0.7', lastmod: '2026-08-15' },
  { path: '/set-up-super-fund',                                   changefreq: 'yearly',  priority: '0.7', lastmod: '2026-08-14' },
  { path: '/what-is-management-accounting',                       changefreq: 'yearly',  priority: '0.7', lastmod: '2026-08-13' },
  { path: '/what-is-break-even-analysis',                        changefreq: 'yearly',  priority: '0.7', lastmod: '2026-08-12' },
  { path: '/how-to-read-a-balance-sheet',                        changefreq: 'yearly',  priority: '0.7', lastmod: '2026-08-11' },
  { path: '/victoria-payroll-tax',                                changefreq: 'yearly',  priority: '0.7', lastmod: '2026-08-05' },
  { path: '/property-investment-using-superannuation',            changefreq: 'yearly',  priority: '0.7', lastmod: '2026-06-25' },
  { path: '/the-atos-free-super-clearing-house-is-closing-what-your-melbourne-small-business-needs-to-do-before-30-june-2026', changefreq: 'yearly', priority: '0.7', lastmod: '2026-06-16' },
  { path: '/tax-deductions-sole-trader',                          changefreq: 'yearly',  priority: '0.7', lastmod: '2026-05-27' },
  { path: '/how-to-salary-sacrifice-super',                       changefreq: 'yearly',  priority: '0.7', lastmod: '2026-05-18' },
  { path: '/tax-return-deadline',                                 changefreq: 'yearly',  priority: '0.7', lastmod: '2026-05-13' },
  { path: '/discretionary-trust-vs-family-trust',                 changefreq: 'yearly',  priority: '0.7', lastmod: '2026-04-27' },
  { path: '/investment-property-tax-deductions-australia',        changefreq: 'yearly',  priority: '0.7', lastmod: '2026-04-13' },
  { path: '/payday-super-for-2026-the-small-business-accountants-checklist-to-stay-compliant-and-protect-cash-flow', changefreq: 'yearly', priority: '0.7', lastmod: '2026-03-30' },
  { path: '/salary-sacrifice-is-it-worth-it',                     changefreq: 'yearly',  priority: '0.7', lastmod: '2026-03-10' },
  { path: '/cash-flow-problems-in-small-business',                changefreq: 'yearly',  priority: '0.7', lastmod: '2026-02-13' },
  { path: '/best-accounting-software-for-small-business-australia', changefreq: 'yearly', priority: '0.7', lastmod: '2026-02-02' },
  { path: '/melbourne-tradies-tax-tips-and-bookkeeping-mistakes',  changefreq: 'yearly',  priority: '0.7', lastmod: '2025-10-27' },
  { path: '/how-to-pay-yourself-as-a-business-owner-without-triggering-ato-red-flags', changefreq: 'yearly', priority: '0.7', lastmod: '2025-08-04' },
  { path: '/the-impact-of-rising-interest-rates-on-small-businesses', changefreq: 'yearly', priority: '0.7', lastmod: '2025-06-26' },
  { path: '/should-your-small-business-register-for-gst',         changefreq: 'yearly',  priority: '0.7', lastmod: '2025-06-15' },
  { path: '/navigating-the-2025-tax-changes-what-small-businesses-in-melbourne-need-to-know', changefreq: 'yearly', priority: '0.7', lastmod: '2025-05-19' },
  { path: '/top-small-business-bookkeeping-tips',                 changefreq: 'yearly',  priority: '0.7', lastmod: '2025-04-23' },
  { path: '/top-small-business-grants-for-2025',                  changefreq: 'yearly',  priority: '0.7', lastmod: '2025-02-20' },
  { path: '/10-ways-to-reduce-your-business-tax-bill',            changefreq: 'yearly',  priority: '0.7', lastmod: '2025-02-05' },
  { path: '/succession-planning-for-small-businesses',            changefreq: 'yearly',  priority: '0.7', lastmod: '2025-01-29' },
  { path: '/the-impact-of-ai-in-small-business',                  changefreq: 'yearly',  priority: '0.7', lastmod: '2024-08-19' },
  { path: '/how-to-handle-an-ato-audit-letter-step-by-step-guide', changefreq: 'yearly', priority: '0.7', lastmod: '2024-07-11' },
  { path: '/your-guide-to-the-best-melbourne-accountants-in-2024', changefreq: 'yearly', priority: '0.7', lastmod: '2024-04-16' },
  { path: '/strategic-plan-for-small-business',                   changefreq: 'yearly',  priority: '0.7', lastmod: '2020-05-11' },
  { path: '/business-structures-pros-cons',                       changefreq: 'yearly',  priority: '0.7', lastmod: '2020-04-14' },
