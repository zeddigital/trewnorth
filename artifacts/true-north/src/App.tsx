...
const BlogPostSetUpSuperFund = lazy(() => import('@/pages/blog-post-set-up-super-fund'));
  ...
  return (
    ...
    <Suspense fallback={null}>
      <Switch>
        ...
        <Route path="/should-your-small-business-register-for-gst" component={BlogPostGST} />
        <Route path="/the-impact-of-rising-interest-rates-on-small-businesses" component={BlogPostInterestRates} />
        <Route path="/melbourne-tradies-tax-tips-and-bookkeeping-mistakes" component={BlogPostTradies} />
        <Route path="/top-small-business-bookkeeping-tips" component={BlogPostBookkeepingTips} />
        <Route path="/the-impact-of-ai-in-small-business" component={BlogPostAISmallBusiness} />
        <Route path="/top-small-business-grants-for-2025" component={BlogPostGrants2025} />
        ...
        <Route path="/accounting-for-a-small-business" component={BlogPostDraftAccountingForASmallBusiness} />
        <Route path="/bookkeeping-services-for-small-business" component={BlogPostDraftBookkeepingServicesForSmallBusiness} />
        <Route path="/small-business-accounting-software-australia" component={BlogPostDraftSmallBusinessAccountingSoftwareAustralia} />
        <Route path="/accountant-for-small-business-melbourne" component={BlogPostDraftAccountantForSmallBusinessMelbourne} />
        <Route path="/small-business-accounting-melbourne" component={BlogPostDraftSmallBusinessAccountingMelbourne} />
        <Route path="/small-business-concessions" component={BlogPostDraftSmallBusinessConcessions} />
        <Route path="/super-guarantee-rate-2024" component={BlogPostDraftSuperGuaranteeRate2024} />
        <Route path="/smsf-accountant-melbourne" component={BlogPostDraftSmsfAccountantMelbourne} />
        <Route path="/setting-up-self-managed-super-fund" component={BlogPostDraftSettingUpSelfManagedSuperFund} />
        <Route path="/what-is-a-self-managed-super-fund" component={BlogPostDraftWhatIsASelfManagedSuperFund} />
        <Route path="/self-managed-super-fund-costs" component={BlogPostDraftSelfManagedSuperFundCosts} />
        <Route path="/payroll-taxes-australia" component={BlogPostDraftPayrollTaxesAustralia} />
        <Route path="/self-managed-super-fund-advice" component={BlogPostDraftSelfManagedSuperFundAdvice} />
        <Route path="/late-tax-return-penalties" component={BlogPostDraftLateTaxReturnPenalties} />
        <Route path="/work-from-home-rate" component={BlogPostDraftWorkFromHomeRate} />
        <Route path="/tax-refund-calculator-australia" component={BlogPostDraftTaxRefundCalculatorAustralia} />
        <Route path="/smsf-accounting-melbourne" component={BlogPostDraftSmsfAccountingMelbourne} />
        <Route path="/payroll-tax-victoria" component={BlogPostDraftPayrollTaxVictoria} />
        ...
        <Route path="/what-are-smsf" component={BlogPostDraftWhatAreSmsf} />
        <Route path="/small-business-tax-deductions" component={BlogPostDraftSmallBusinessTaxDeductions} />
        <Route path="/what-is-accrual-accounting" component={BlogPostDraftWhatIsAccrualAccounting} />
        <Route path="/accountant-fees-for-small-business" component={BlogPostDraftAccountantFeesForSmallBusiness} />
        <Route path="/log-book-for-tax" component={BlogPostDraftLogBookForTax} />
        ...
        <Route path="/fbt-due-date" component={BlogPostDraftFbtDueDate} />
        <Route path="/smsf-setting-up" component={BlogPostDraftSmsfSettingUp} />
        <Route path="/tax-deductions-home-office" component={BlogPostDraftTaxDeductionsHomeOffice} />
        <Route path="/why-do-i-have-to-pay-payg-instalments" component={BlogPostDraftWhyDoIHaveToPayPaygInstalments} />
        <Route path="/how-to-do-depreciation" component={BlogPostDraftHowToDoDepreciation} />
